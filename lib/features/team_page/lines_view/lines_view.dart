...
import 'package:flutter_project_template_firebase/features/team_page/lines_view/componets/full_strength.dart';
...
class LinesView extends StatelessWidget {
  ...
  Widget _getCurrentStepPage({required int currentStep}) {
    switch (currentStep) {
      ...
      case 1:
        return const FullStrength(key: ValueKey<int>(1));
      case 2:
